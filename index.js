...
function Deck() {
    ...
    this.add("action", 1, 2, "Rent", "Choose one of these colors. All players pay you rent for all Properties you own in that color.", "lightgreen black");
    this.add("action", 1, 2, "Rent", "Choose one of these colors. All players pay you rent for all Properties you own in that color.", "lightblue brown");
    ...
    this.add("action", 3, 3, "Sly Deal", "Steal one Property from any player, and place it in front of you. You may not steal a Property that's part of a complete set");
    ...
    this.add("property", 0, 2, "Wild Property", "This card may be used as part of any property set", "red purple orange green yellow lightgreen brown black lightblue blue");
    ...
    this.add("property", 1, 1, "Connecticut Avenue", "1 2 3", "lightblue");
    this.add("property", 1, 1, "Vermont Avenue", "1 2 3", "lightblue");
    this.add("property", 1, 1, "Oriental Avenue", "1 2 3", "lightblue");
    ...
    this.add("property", 2, 1, "Electric Company", "1 2", "lightgreen");
    this.add("property", 2, 1, "Water Works", "1 2", "lightgreen");
    ...
    this.add("property", 2, 2, "Wild Property", "Choose one color", "lightgreen black");
    this.add("property", 1, 2, "Wild Property", "Choose one color", "lightblue brown");
    this.add("property", 4, 2, "Wild Property", "Choose one color", "lightblue black");
...
io.on('connection', (socket) => {
    if (gameStarted) {
        io.to(socket.id).emit("join-failure", "A game is already being played!");
    }
    if (players.length >= 5) {
        io.to(socket.id).emit("join-failure", "There are already too many players!");
    }
